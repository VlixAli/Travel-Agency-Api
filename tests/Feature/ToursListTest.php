...
class ToursListTest extends TestCase
{
    ...
    public function test_tours_price_is_showing_correctly(): void
    {
        $travel = Travel::factory()->create();
    ...
    public function test_tours_list_sorts_by_price_correctly(): void
    {
        ...
        $response = $this->get('/api/travels/'.$travel->slug.'/tours?orderBy=asc');
    ...
    public function test_tours_list_filters_by_staring_date_correctly(): void
    {
        $travel = Travel::factory()->create();
        $laterTour = Tour::factory()->create([
            'travel_id' => $travel->id,
    ...
    public function test_tour_list_returns_validation_errors(): void
    {
        ...
        $response = $this->getJson('api/travels/'.$travel->slug.'/tours?dateFrom=abc');
        $response->assertStatus(422);

        $response = $this->getJson('api/travels/'.$travel->slug.'/tours?priceFrom=abc');
        $response->assertStatus(422);
    }
}
